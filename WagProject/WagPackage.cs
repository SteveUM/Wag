...
namespace WagProject
{
    ...
    [ProvideToolWindow(typeof(Wag))]
    [Guid(WagPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class WagPackage : AsyncPackage
    {
        /// <summary>
        /// WagPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "4891f760-4220-4b4e-951f-232c646b508d";

        /// <summary>
        /// Initializes a new instance of the <see cref="WagPackage"/> class.
        /// </summary>
        public WagPackage()
        {
            ...
            WagPackage.LogMessage(nameof(WagControl));
        }
